"""
Script to generate Django password hashes for the fixture file
"""
import os
import django
...
test_credentials = {
    "chef.john@example.com": "chef123",
    "chef.maria@example.com": "chef456",
...
# Print the hashes for use in the fixture
print("Generated password hashes:")
for email, data in password_hashes.items():
    print(f"{email}: {data['password']}")
    print(f"  Plaintext: {data['plaintext']}")
    print()

# Also create the fixture content
fixture_content = """[
  {
  ...
  },
  {
    ...
    "fields": {
      ...
      "is_active": true,
      "is_staff": false,
      "date_joined": "2023-04-05T16:45:00Z",
      "password": "%s"
    }
  },
  {
    "model": "authentication.chef",
    "pk": 1,
    "fields": {
      "user": 1,
      "rating": 4.8,
  ...
  {
    "model": "authentication.paymentcard",
    "pk": 1,
    "fields": {
      "user": 3,
      "card_last4": "1111",
  ...
  },
  {
    ...
    "fields": {
      ...
      "created_at": "2023-02-05T18:30:00Z"
    }
  },
  {
    "model": "dishes.dishreview",
  ...
  },
  {
    ...
    "fields": {
      ...
      "created_at": "2023-02-08T19:45:00Z"
    }
  },
  {
    "model": "dishes.dishreview",
  ...
  {
    "model": "dishes.dishvarietysection",
    "pk": 1,
    "fields": {
      "dish": 1,
      "name": "Size Options",
  ...
  {
    "model": "dishes.dishvarietyoption",
    "pk": 1,
    "fields": {
      "section": 1,
      "name": "Small",
  ...
  },
  {
    ...
    password_hashes["chef.john@example.com"]["password"],
    password_hashes["chef.maria@example.com"]["password"],
    password_hashes["consumer.sarah@example.com"]["password"],
    password_hashes["consumer.mike@example.com"]["password"]
)

# Write the fixture to a file
with open("proper_fixture.json", "w") as f:
    f.write(fixture_content)

print("\nFixture content written to 'proper_fixture.json'")