...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    address_longitude = models.DecimalField(max_digits=12, decimal_places=11, null=True, blank=True)
    address_latitude = models.DecimalField(max_digits=12, decimal_places=11, null=True, blank=True)
